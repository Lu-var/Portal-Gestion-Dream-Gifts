...
//            }
            try {
                input = JOptionPane.showInputDialog(null, "Nueva Red Social", fila.get(1));
                nombre = (String)input;
                if(nombre.isEmpty()){
            ...
            input = JOptionPane.showConfirmDialog(null,"¿Activar esta Red Social? ","Estado Actual: " + status, JOptionPane.YES_NO_OPTION);
...
//            tabla.setValueAt(id, pos, 0);
            ...
            manager.update((int)fila.get(0), nombre, flagStatus);
