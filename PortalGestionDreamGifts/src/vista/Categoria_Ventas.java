 ...
 * @author jav
 */
public class Categoria_Ventas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBut_Des_Ventas.addActionListener(new Login.awt.event.ActionListener() {
        ...
        jLab_List_Cat_Venta.setFont(new Login.awt.Font("Ubuntu", 0, 24)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Login.util.logging.Logger.getLogger(Categoria_Ventas.class.getName()).log(Login.util.logging.Level.SEVERE, null, ex);
        ...
        Login.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Categoria_Ventas().setVisible(true);
            }
        });
    }
